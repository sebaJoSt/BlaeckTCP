...
Devices | B3 | `<MasterSlaveConfig><SlaveID><DeviceName><DeviceHWVersion><DeviceFWVersion><LibraryVersion><LibraryName>` | Response to request for device information `<BLAECK.GET_DEVICES>`
