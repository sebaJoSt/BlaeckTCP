/*
  ...
  NetworkSetup.h gets the board online. Connect a host to the address printed on the serial
  monitor, port 23. From a terminal, <BLAECK.ACTIVATE,1000> requests one binary data frame per
  second and makes that connection a host; <BLAECK.DEACTIVATE> stops the timed data.
