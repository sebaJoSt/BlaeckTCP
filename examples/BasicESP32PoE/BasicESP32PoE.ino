/*
  ...
  from the Olimex ESP32-PoE-ISO Rev.L board (Server) to your PC (Client), at the interval a host asks for.
...
void setup()
{
  ...
  Blaeck.DeviceName = "Random Number Generator ESP32PoE";
  Blaeck.DeviceHWVersion = "ESP32-PoE-ISO Rev.L";
