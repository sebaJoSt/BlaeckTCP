...
//        BlaeckTCPConfig.h next to your .ino is found by every unit.
//
//     b) Staying in the IDE, and no config file needed: put the settings at
//        libraries/BlaeckTCP/src/BlaeckTCPConfig.h, next to this header.
//        That folder is already on the include path, so every unit sees it.
//        The catch is that a library update overwrites it.
//
...
//
//        2. BlaeckTCPConfig.h, in the sketch folder next to your .ino:
//
//             MySketch\
//               MySketch.ino
//               BlaeckTCPConfig.h
